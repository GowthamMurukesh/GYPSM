        ...
        <section className="relative overflow-hidden bg-[radial-gradient(circle_at_top_right,_rgba(181,144,90,0.18),_transparent_28%),linear-gradient(180deg,#f8f1e6_0%,#f0e3d6_100%)] py-20 sm:py-28 text-foreground">
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="max-w-3xl">
              <span className="inline-flex rounded-full border border-accent/20 bg-orange-500 px-4 py-2 text-xs font-semibold uppercase tracking-[0.28em] text-accent shadow-sm shadow-accent/10 mb-6 opacity-0 animate-fadeInUp text-white" style={{ animationDelay: '0.1s', animationFillMode: 'forwards' }}>
                Contact
              </span>
              <h1 className="text-4xl sm:text-5xl font-bold mb-4 leading-tight opacity-0 animate-fadeInUp text-[#130CB7]" style={{ animationDelay: '0.2s', animationFillMode: 'forwards' }}>
